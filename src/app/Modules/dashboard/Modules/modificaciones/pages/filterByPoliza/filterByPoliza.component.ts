...
import { Subject, switchMap, Observable, debounceTime, distinctUntilChanged, of, tap } from 'rxjs';
...
@Component({
  templateUrl : './filterByPoliza.component.html',
  styleUrls: ['./filterByPoliza.component.css'],
})
export class FilterByPolizaComponent {
  ngOnInit(): void {
